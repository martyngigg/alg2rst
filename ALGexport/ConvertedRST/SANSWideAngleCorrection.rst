...
The equation for the reduction is (see `Q1D <Q1D>`__)
...
This parameter enters inside `Q1D <Q1D>`__ as WavePixelAdj. But, this is
...
`ApplyTransmissionCorrection <ApplyTransmissionCorrection>`__ algorithm.
...
.. figure:: SNS_ISIS_WideAngleCorrections.png
...
`Q1D <Q1D>`__ algorithm, while at ISIS, it is used after, inside the
`Q1D <Q1D>`__ algorithm, for the division of the counters per bin
